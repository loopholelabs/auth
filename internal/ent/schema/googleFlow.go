...
// GoogleFlow holds the schema definition for the Flow entity.
type GoogleFlow struct {
	ent.Schema
}

// Fields of the GoogleFlow.
func (GoogleFlow) Fields() []ent.Field {
	return []ent.Field{
...
// Edges of the GoogleFlow.
func (GoogleFlow) Edges() []ent.Edge {
	return nil
}
