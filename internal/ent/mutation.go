...
// SetIdentifier sets the "identifier" field.
func (m *GithubFlowMutation) SetIdentifier(s string) {
	m.identifier = &s
}

// Identifier returns the value of the "identifier" field in the mutation.
func (m *GithubFlowMutation) Identifier() (r string, exists bool) {
	v := m.identifier
	if v == nil {
		return
	}
...
// OldIdentifier returns the old "identifier" field's value of the GithubFlow entity.
// If the GithubFlow object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GithubFlowMutation) OldIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIdentifier resets all changes to the "identifier" field.
func (m *GithubFlowMutation) ResetIdentifier() {
	m.identifier = nil
}
...
func (m *GithubFlowMutation) Fields() []string {
	...
	if m.identifier != nil {
		fields = append(fields, githubflow.FieldIdentifier)
	}
	if m.verifier != nil {
...
// SetIdentifier sets the "identifier" field.
func (m *GoogleFlowMutation) SetIdentifier(s string) {
	m.identifier = &s
}

// Identifier returns the value of the "identifier" field in the mutation.
func (m *GoogleFlowMutation) Identifier() (r string, exists bool) {
	v := m.identifier
	if v == nil {
		return
	}
...
// OldIdentifier returns the old "identifier" field's value of the GoogleFlow entity.
// If the GoogleFlow object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GoogleFlowMutation) OldIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIdentifier resets all changes to the "identifier" field.
func (m *GoogleFlowMutation) ResetIdentifier() {
	m.identifier = nil
}
...
func (m *GoogleFlowMutation) Fields() []string {
	...
	if m.identifier != nil {
		fields = append(fields, googleflow.FieldIdentifier)
	}
	if m.verifier != nil {
...
func (m *GoogleFlowMutation) Field(name string) (ent.Value, bool) {
	...
	case googleflow.FieldCreatedAt:
		return m.CreatedAt()
	case googleflow.FieldIdentifier:
		return m.Identifier()
...
// SetIdentifier sets the "identifier" field.
func (m *MagicFlowMutation) SetIdentifier(s string) {
	m.identifier = &s
}

// Identifier returns the value of the "identifier" field in the mutation.
func (m *MagicFlowMutation) Identifier() (r string, exists bool) {
	v := m.identifier
	if v == nil {
		return
	}
...
// OldIdentifier returns the old "identifier" field's value of the MagicFlow entity.
// If the MagicFlow object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MagicFlowMutation) OldIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIdentifier resets all changes to the "identifier" field.
func (m *MagicFlowMutation) ResetIdentifier() {
	m.identifier = nil
}
...
func (m *MagicFlowMutation) Fields() []string {
	...
	if m.identifier != nil {
		fields = append(fields, magicflow.FieldIdentifier)
	}
	if m.email != nil {
