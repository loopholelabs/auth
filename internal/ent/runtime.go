...
func init() {
	...
	deviceflowDescIdentifier := deviceflowFields[1].Descriptor()
	...
	deviceflowDescDeviceCode := deviceflowFields[2].Descriptor()
	...
	deviceflowDescUserCode := deviceflowFields[3].Descriptor()
	...
	deviceflowDescLastPoll := deviceflowFields[5].Descriptor()
	...
	// githubflowDescIdentifier is the schema descriptor for identifier field.
	githubflowDescIdentifier := githubflowFields[1].Descriptor()
	// githubflow.IdentifierValidator is a validator for the "identifier" field. It is called by the builders before save.
	githubflow.IdentifierValidator = githubflowDescIdentifier.Validators[0].(func(string) error)
	...
	// googleflowDescIdentifier is the schema descriptor for identifier field.
	googleflowDescIdentifier := googleflowFields[1].Descriptor()
	// googleflow.IdentifierValidator is a validator for the "identifier" field. It is called by the builders before save.
	googleflow.IdentifierValidator = googleflowDescIdentifier.Validators[0].(func(string) error)
	...
	// magicflowDescIdentifier is the schema descriptor for identifier field.
	magicflowDescIdentifier := magicflowFields[1].Descriptor()
	// magicflow.IdentifierValidator is a validator for the "identifier" field. It is called by the builders before save.
	magicflow.IdentifierValidator = magicflowDescIdentifier.Validators[0].(func(string) error)
	// magicflowDescEmail is the schema descriptor for email field.
	magicflowDescEmail := magicflowFields[2].Descriptor()
	...
	magicflowDescIPAddress := magicflowFields[3].Descriptor()
	...
	magicflowDescSecret := magicflowFields[4].Descriptor()
	...
	magicflowDescNextURL := magicflowFields[5].Descriptor()
